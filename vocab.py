...
add_tok(FeatToken('i', {CAT: DP, CASE: NOM, COUNT: SING, PERSON: FIRST, PRO: True}))
add_tok(FeatToken('me', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: FIRST, PRO: True}))
add_tok(FeatToken('myself', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: FIRST, PRO: True}))
add_tok(Determiner('my', ANY))
add_tok(FeatToken('mine', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('we', {CAT: DP, CASE: NOM, COUNT: PLUR, PERSON: FIRST, PRO: True}))
add_tok(FeatToken('us', {CAT: DP, CASE: ACC, COUNT: PLUR, PERSON: FIRST, PRO: True}))
add_tok(FeatToken('ourselves', {CAT:DP, CASE: ACC, COUNT: PLUR, PERSON: FIRST, PRO: True}))
add_tok(Determiner('our', ANY))
add_tok(FeatToken('ours', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('you', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: SECOND, PRO: True}))
add_tok(FeatToken('yourself', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: SECOND, PRO: True}))
add_tok(FeatToken('yourselves', {CAT: DP, CASE: ACC, COUNT: PLUR, PERSON: SECOND, PRO: True}))
add_tok(Determiner('your', ANY))
add_tok(FeatToken('yours', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('he', {CAT: DP, CASE: NOM, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('him', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('himself', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(Determiner('his', ANY))
add_tok(FeatToken('his', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('she', {CAT: DP, CASE: NOM, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('her', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('herself', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(Determiner('her', ANY))
add_tok(FeatToken('hers', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('it', {CAT: DP, CASE: ANY, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('itself', {CAT: DP, CASE: ACC, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(Determiner('its', ANY))
add_tok(FeatToken('its', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('they', {CAT: DP, CASE: NOM, COUNT: PLUR, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('them', {CAT: DP, CASE: ACC, COUNT: PLUR, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('themselves', {CAT: DP, CASE: ACC, COUNT: PLUR, PERSON: THIRD, PRO: True}))
add_tok(Determiner('their', ANY))
add_tok(FeatToken('theirs', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, PRO: True}))
add_tok(FeatToken('that', {CAT: DP, CASE: ANY, COUNT: SING, PERSON: THIRD, REL: True, PRO: True}))
add_tok(Determiner('that', SING))
add_tok(FeatToken('those', {CAT: DP, CASE: ANY, COUNT: PLUR, PERSON: THIRD, PRO: True}))
add_tok(Determiner('those', PLUR))
add_tok(FeatToken('this', {CAT: DP, CASE: ANY, COUNT: SING, PERSON: THIRD, PRO: True}))
add_tok(Determiner('this', SING))
add_tok(FeatToken('these', {CAT: DP, CASE: ANY, COUNT: PLUR, PERSON: THIRD, PRO: True}))
add_tok(Determiner('these', PLUR))

add_tok(FeatToken('what', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, REL: REL_EXT, PRO: True}))
add_tok(FeatToken('who', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, REL: REL_EXT, PRO: True}))
add_tok(FeatToken('where', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, LOC: True, REL: REL_EXT, PRO: True}))
add_tok(FeatToken('which', {CAT: DP, CASE: ANY, COUNT: ANY, PERSON: THIRD, REL: REL_EXT, PRO: True}))
add_tok(Complementizer('why', {CAT: VP, FORM: [PRES, PRET]}))
add_tok(FeatToken('whom', {CAT: DP, CASE: ACC, COUNT: ANY, PERSON: THIRD, REL: REL_EXT, PRO: True}))

...
add_tok(VerbAux('do', PRES, [nom_subj_pat([FIRST, SECOND], SING), nom_subj_pat(ANY, PLUR)], modal_arg_pat))
add_tok(VerbAux('does', PRES, nom_subj_pat(THIRD, SING), modal_arg_pat))
add_tok(VerbAux('did', PRET, nom_subj_pat_any, modal_arg_pat))
add_tok(VerbAuxInter('do', PRES, [nom_subj_pat([FIRST, SECOND], SING), nom_subj_pat(ANY, PLUR)], modal_arg_pat))
